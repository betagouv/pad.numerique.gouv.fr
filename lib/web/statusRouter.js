...
statusRouter.get('/stats/users/:year/:month', function (req, res, next) {
  statistics.getActiveUsersForSpecificMonth(
    {
...
statusRouter.get('/stats/users/lastMonth', function (req, res, next) {
  statistics.getActiveUsersForLastMonth(function (data) {
    res.set({ 'Content-Type': 'application/json' })
    res.send(data)
  }
  )
