...
const { agentConnectAuthenticate, agentConnectAuthorizeUrl } = require('./agentConnect')
...
authRouter.get('/agent-connect/login', agentConnectAuthorizeUrl)
authRouter.get('/oidc-callback', agentConnectAuthenticate)
