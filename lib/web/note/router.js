...
const silentLogin = require('../auth/agentConnect/silentLogin')
...
router.post('/summary', markdownParser, noteController.createSummary)
...
// get note by id
router.get('/:noteId', silentLogin, noteController.showNote)
// note actions
