...
module.exports = {
  ...
  botId: process.env.CMD_BOT_ID,
  isEmailEnableForBotOnly: process.env.CMD_IS_EMAIL_ENABLE_FOR_BOT_ONLY,
  ...
  s3bucketURL: process.env.CMD_S3_BUCKET_URL,
  ...
  agentConnect: {
    providerName: process.env.CMD_AGENT_CONNECT_PROVIDER_NAME,
    clientID: process.env.CMD_AGENT_CONNECT_CLIENTID,
    clientSecret: process.env.CMD_AGENT_CONNECT_CLIENTSECRET,
    baseUrl: process.env.CMD_AGENT_CONNECT_BASE_URL,
    userinfoSignedResponseAlg: process.env.CMD_AGENT_CONNECT_USER_INFO_SIGNED_RESPONSE_ALG,
    scopes: process.env.CMD_AGENT_CONNECT_SCOPES,
    acrValues: process.env.CMD_AGENT_CONNECT_ACR_VALUES
  },
  ...
  spellCheckerEndpoint: process.env.SPELL_CHECKER_ENDPOINT,
  spellCheckerDisabledRuleIds: process.env.SPELL_CHECKER_DISABLED_RULE_IDS
}
